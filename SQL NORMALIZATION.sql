...
create table tblNormalForm
(ClientNo varchar(10) not null, Cname varchar(100),PropertyNo varchar(20),Paddress varchar(100),
rentstart varchar(10),rentfinish varchar(10), rent float, ownerno varchar(20),OName varchar(100))


 insert into tblNormalForm
  values
