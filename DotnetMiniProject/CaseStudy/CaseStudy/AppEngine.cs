...
namespace CaseStudy
{
    class AppEngine
    {
        ...
        static SqlConnection getConnection()
        {
            ...
            con = new SqlConnection("data source = ADMW46ZLPC1609\\SQLEXPRESS; Initial Catalog=StudentMangement; user id=sa; password=Temp1234");
            con.Open();
            return con;
        }
        ...
        public void New_StudentRegistration()
        {
            ...
            {
                con = getConnection();
                Console.WriteLine("Enter Student ID, NAME and DOB");
                int Id;
        ...
        public void Available_Courses()
        {
            ...
            Console.WriteLine("The List of Avaliable Courses are ...!");
            dr = cmd.ExecuteReader();
            while (dr.Read())
            {
        ...
        public void UpdateStudentData()
        {
            ...
            if (res7 > 0)
            {
                Console.WriteLine("Student details is Sucessfully Updated ");
            }
            else
                Console.WriteLine("please enter valid student details");
        }
        ...
        public void DeleteCourseData()
        {
            ...
            if (res9 > 0)
            {
                Console.WriteLine("Entered Course Details is Sucessfully Deleted ");
            }
            else
                Console.WriteLine("Please enter valid Course details");
        }
